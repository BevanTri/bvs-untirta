        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-brand-steel/10">
                    ...
                    <td class="p-3 text-center">
                        <button onclick="document.getElementById('brand-edit-{{ $b->id }}').classList.toggle('hidden')" class="text-brand-amber text-sm font-medium hover:underline">Edit</button>
