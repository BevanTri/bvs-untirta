<x-admin-layout>
    ...
    <x-card class="mb-6">
        <form method="POST" action="{{ route('admin.services.store') }}" class="flex gap-2 flex-wrap">
            @csrf
            ...
            <button type="submit" class="btn-primary shrink-0 w-full md:w-auto min-h-[44px]">Tambah</button>
        </form>
    </x-card>
