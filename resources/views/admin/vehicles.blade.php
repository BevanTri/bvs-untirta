<x-admin-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="card p-0 overflow-hidden">
                ...
                <table class="table-base">
                    <thead>
                        <tr class="border-b border-brand-border/20 dark:border-brand-navy-3/50 bg-brand-warm dark:bg-brand-navy-3/30">
                            ...
                            <th class="p-3 text-left font-semibold text-brand-ink-muted text-xs uppercase tracking-widest whitespace-nowrap">Tipe</th>
                            <th class="p-3 text-left font-semibold text-brand-ink-muted text-xs uppercase tracking-widest whitespace-nowrap">Pelanggan</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-brand-border/10 dark:border-brand-navy-3/50">
                            <td class="p-3 text-left font-medium font-mono tabular-nums">{{ $v->plate_number }}</td>
                            <td class="p-3 text-left">{{ $v->brand }}</td>
                            <td class="p-3 text-left text-brand-ink-muted whitespace-nowrap">{{ $v->model }}</td>
                            <td class="p-3 text-left whitespace-nowrap">{{ $v->customer->name }}</td>
            ...
            <div class="p-4 border-t border-brand-border dark:border-brand-navy-3"> {{ $vehicles->links() }} </div>
            @endif
        </div>
    </div>
</x-admin-layout>
