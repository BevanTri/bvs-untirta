...
<div class="bottom-sheet-picker" data-picker="{{ $pickerId }}" data-onselect="{{ $onselect }}">
    ...
    <div id="picker-sheet-{{ $pickerId }}" class="picker-sheet fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-2xl shadow-2xl translate-y-full max-h-[70vh] flex flex-col" data-picker="{{ $pickerId }}">
