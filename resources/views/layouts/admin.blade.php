...
<body class="font-sans antialiased bg-brand-warm text-brand-ink overflow-x-hidden">
    <div class="flex h-screen overflow-hidden">
        {{-- Sidebar --}}
        <aside class="hidden md:flex md:flex-col w-64 bg-brand-navy text-white shrink-0">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.dashboard') ? 'text-brand-gold bg-brand-gold/10 border-l-2 border-brand-gold' : 'text-zinc-400 hover:text-white hover:bg-white/5' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    Dashboard
                </a>
                <a href="{{ route('admin.categories') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.categories') ? 'text-brand-gold bg-brand-gold/10 border-l-2 border-brand-gold' : 'text-zinc-400 hover:text-white hover:bg-white/5' }}">
                ...
                <a href="{{ route('admin.products') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.products') ? 'text-brand-gold bg-brand-gold/10 border-l-2 border-brand-gold' : 'text-zinc-400 hover:text-white hover:bg-white/5' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                    Produk
                </a>
                <a href="{{ route('admin.services') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.services') ? 'text-brand-gold bg-brand-gold/10 border-l-2 border-brand-gold' : 'text-zinc-400 hover:text-white hover:bg-white/5' }}">
                ...
                <a href="{{ route('admin.brands') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.brands') ? 'text-brand-gold bg-brand-gold/10 border-l-2 border-brand-gold' : 'text-zinc-400 hover:text-white hover:bg-white/5' }}">
                ...
                <a href="{{ route('admin.orders') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.orders') ? 'text-brand-gold bg-brand-gold/10 border-l-2 border-brand-gold' : 'text-zinc-400 hover:text-white hover:bg-white/5' }}">
        ...
        {{-- Mobile Sidebar --}}
        <div id="mobile-sidebar" class="md:hidden fixed inset-0 z-50 bg-white/95 backdrop-blur-sm hidden">
            ...
            <nav class="p-4 space-y-1">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.dashboard') ? 'text-brand-gold bg-brand-gold/10' : 'text-brand-ink-muted hover:text-brand-navy hover:bg-brand-warm-2' }}"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg> Dashboard</a>
                <a href="{{ route('admin.categories') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.categories') ? 'text-brand-gold bg-brand-gold/10' : 'text-brand-ink-muted hover:text-brand-navy hover:bg-brand-warm-2' }}"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg> Kategori</a>
                <a href="{{ route('admin.products') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.products') ? 'text-brand-gold bg-brand-gold/10' : 'text-brand-ink-muted hover:text-brand-navy hover:bg-brand-warm-2' }}"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg> Produk</a>
                <a href="{{ route('admin.services') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.services') ? 'text-brand-gold bg-brand-gold/10' : 'text-brand-ink-muted hover:text-brand-navy hover:bg-brand-warm-2' }}"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg> Service</a>
                <a href="{{ route('admin.brands') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.brands') ? 'text-brand-gold bg-brand-gold/10' : 'text-brand-ink-muted hover:text-brand-navy hover:bg-brand-warm-2' }}"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg> Brand</a>
                <a href="{{ route('admin.orders') }}" class="flex items-center gap-3 px-3 py-2.5 text-sm font-medium transition-colors {{ request()->routeIs('admin.orders') ? 'text-brand-gold bg-brand-gold/10' : 'text-brand-ink-muted hover:text-brand-navy hover:bg-brand-warm-2' }}"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg> Pesanan</a>
                <hr class="border-brand-border my-3">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="flex items-center gap-3 px-3 py-2.5 w-full text-sm font-medium text-brand-ink-muted hover:text-brand-blue hover:bg-brand-warm-2 transition-colors"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg> Logout</button>
                </form>
            </nav>
        </div>
