...
<body class="font-sans antialiased bg-brand-warm dark:bg-brand-navy text-brand-ink dark:text-zinc-100">
    <div class="flex md:h-screen flex-col md:flex-row">
        {{-- Sidebar --}}
        <aside class="hidden md:flex md:flex-col w-64 bg-white dark:bg-brand-navy text-brand-ink dark:text-white shrink-0 md:min-h-screen border-r border-brand-border dark:border-brand-navy-3">
            <div class="h-16 flex items-center px-6 border-b border-brand-border dark:border-white/10">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3">
                <div class="mb-1 px-3 py-1 text-[10px] font-display font-semibold uppercase tracking-[0.15em] text-brand-ink-faint dark:text-zinc-500">Umum</div>
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2 text-sm font-medium transition-colors rounded-lg {{ request()->routeIs('admin.dashboard') ? 'text-brand-gold bg-brand-gold/10' : 'text-brand-ink-muted hover:text-brand-ink hover:bg-brand-warm-2 dark:text-zinc-400 dark:hover:text-white dark:hover:bg-white/5' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    Dashboard
                </a>
                <div class="mt-4 mb-1 px-3 py-1 text-[10px] font-display font-semibold uppercase tracking-[0.15em] text-brand-ink-faint dark:text-zinc-500">Data Master</div>
                ...
                <div class="mt-4 mb-1 px-3 py-1 text-[10px] font-display font-semibold uppercase tracking-[0.15em] text-brand-ink-faint dark:text-zinc-500">Transaksi</div>
            ...
            <div class="px-3 py-4 border-t border-brand-border dark:border-white/10">
                <div class="flex items-center gap-3 px-3 py-2">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="text-sm font-medium truncate text-brand-ink dark:text-white">{{ Auth::user()->name }}</div>
                        <div class="text-xs text-brand-ink-muted dark:text-zinc-500">Admin</div>
                    </div>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="text-brand-ink-muted hover:text-brand-gold dark:text-zinc-500 dark:hover:text-brand-gold text-xs transition-colors" title="Logout">&larr;</button>
                    </form>
                </div>
            </div>
        </aside>
        ...
        <div id="mobile-sidebar" class="md:hidden fixed inset-0 z-[70] bg-white/95 dark:bg-brand-navy-2/95 backdrop-blur-sm hidden">
            ...
            <nav class="p-4">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2 text-sm font-medium transition-colors rounded-lg {{ request()->routeIs('admin.dashboard') ? 'text-brand-gold bg-brand-gold/10' : 'text-brand-ink-muted dark:text-zinc-400 hover:text-brand-navy dark:hover:text-white hover:bg-brand-warm-2 dark:hover:bg-white/5' }}"><svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg> Dashboard</a>
