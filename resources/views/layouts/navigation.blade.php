        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-14 items-center">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('orders.history') }}" id="nav-orders-link" class="text-brand-ink-muted dark:text-zinc-400 hover:text-brand-blue dark:hover:text-brand-blue-light text-sm transition-colors uppercase font-display tracking-wide touch-target flex items-center">Pesanan</a>
                    ...
                    <div class="relative">
                        <button onclick="toggleUserMenu()" type="button" class="flex items-center text-brand-ink-muted dark:text-zinc-400 hover:text-brand-navy dark:hover:text-zinc-200 transition-colors cursor-pointer touch-target">
                        ...
                        <div id="user-menu" class="hidden absolute right-0 mt-2 w-48 bg-white dark:bg-brand-navy-2 rounded-xl shadow-level-4 border border-brand-border dark:border-brand-navy-3 z-[70] overflow-hidden">
